...
def signature_request_sent(hello_sign_event, callback):
    ...
    esign_id = hello_sign_event['signature_request']['signature_request_id'] 
    l_signers = list()
    ...
    try:
        esign_obj = EsignCreds.objects.get(service_document_id=esign_id, service=service)
    ...
    params['internal_esign_id'] = esign_obj.unique_id
